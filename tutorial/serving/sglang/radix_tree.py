"copy from https://github.com/sgl-project/sglang/blob/main/python/sglang/srt/mem_cache/radix_cache.py"
import heapq
import time
...
class RadixCache:
    ...
    def _match_prefix_helper(self, node: TreeNode, key: List):
        ...
        # get prefix length ids(page_size) from the key
        ...
        while len(key) > 0 and child_key in node.children.keys():
            ...
            # get prefix length token ids from the key
